    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Rishikesh Deshetty</h3>
            <p className="text-gray-400">
              Data Analyst with 3+ years of experience in data analytics, consulting support, and business operations.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>📧 rishikesh.d1020@gmail.com</li>
              <li>📱 +1 (818) 930-4585</li>
              <li>📍 Minneapolis, MN 55417</li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>© {currentYear} Rishikesh Deshetty. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
